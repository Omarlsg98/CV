...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [SectionId.About, SectionId.Resume, SectionId.Contact], // TODO: Add Portfolio and Testimonials
    [],
  );
    ...
    return (
      <>
        <button
          ...
          className="fixed right-2 top-2 z-40 rounded-md bg-teal-500 p-2 ring-offset-gray-800/60 hover:bg-teal-400 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 sm:hidden"
          onClick={toggleOpen}>
